...
function GameOver(pontos) {
  let melhor_ponto = localStorage.getItem("FlappyBird@score");
  if (!melhor_ponto || melhor_ponto < pontos) {
    localStorage.setItem("FlappyBird@score", pontos);
    melhor_ponto = pontos;
    console.log("def");
  }
  ...
  game_over.querySelector(".score").innerHTML = `Pontos: ${pontos}`;
  game_over.querySelector(
    ".score-melhor "
  ).innerHTML = `Melhor pontuação: ${melhor_ponto}`;
}
